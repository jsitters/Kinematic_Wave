...
Qboun2d=(1-np.cos((time2d*np.pi)/450))*(750/np.pi) #np.atleast_2d
...
#plt.plot(time2d,Qout_CO[:,1], 'b', label='Boundary Flow')
plt.plot(time2d,Qout_CO[:,2], 'c', label='FirstCO')
plt.plot(time2d,Qout_Chap[:,2], 'g', label='FirstChap')
#plt.plot(Qout_CO[4], 'r', label='Third')
#plt.plot(Qout_CO[5], 'k', label='Fourth')
plt.ylabel('Flow')
plt.title('Colorado and Chapra Kwave Comparison')
plt.legend(loc='lower right')
#plt.axis([0,360,0,700])